...
var _gameplay = __webpack_require__(/*! ./gameplay */ "./src/gameplay.js");

var _gameplay2 = _interopRequireDefault(_gameplay);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_gameplay2.default, null), document.getElementById("reactcontainer"));
...
var _citylist = __webpack_require__(/*! ./citylist */ "./src/citylist.js");
...
var Game = function (_React$Component) {
	...
	function Game(props) {
		...
		_this.cityListArr = _citylist2.default.cities.split(" ");
		_this.player = true;
	...
	_createClass(Game, [{
		...
		key: "showCity",
		value: function showCity(obj) {
			var arr = this.state.cityObjArr.concat([]);
			arr.push(obj);
			this.setState({
				cityObjArr: arr
			});
		...
		value: function render() {
			if (!this.state.finish) {
				...
				var cityResult = this.state.cityObjArr.map(function (item, index) {
					return _react2.default.createElement(
						"div",
						{ style: { textAlign: item.player ? "left" : "right",
								color: item.player ? "red" : "green" } },
						item.city,
						_react2.default.createElement(
							"span",
							null,
							item.player ? " Игрок" : " Компьютер"
						)
					);
				});
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: "stopbtn" },
							_react2.default.createElement("input", { type: "button", className: "btn btn-secondary btn-lg", id: "stop", onClick: this.finishGame.bind(this), value: "\u0421\u0442\u043E\u043F \u0438\u0433\u0440\u0430" })
						),
						_react2.default.createElement(
							"div",
							{ id: "history" },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement("input", { type: "text", placeholder: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435", className: "text", id: "wordUser", onChange: this.getText.bind(this), value: this.state.userCity }),
								_react2.default.createElement("input", { type: "button", id: "btn", className: "btn btn-secondary", onClick: this.userTurn.bind(this), value: "OK" })
							),
							_react2.default.createElement(
								"div",
								{ id: "computer" },
